                ...
                <div class="timeline-Tweet">
                    ...
                    <div class="timeline-Tweet-author">
                        <div class="TweetAuthor">
                            <a class="TweetAuthor-link" href="<?php the_permalink(); ?>">
                                <?php the_author(); ?>
                            </a>
                            ...
                            <span class="TweetAuthor-name"><?php the_author(); ?></span>
                            <span class="Icon Icon--verified"></span>
                            <span class="TweetAuthor-screenName">@<?php echo get_the_author_meta('user_nicename'); ?></span>
                        </div>
                    </div>
                    <div class="timeline-Tweet-text">
                        <?php the_content(); ?>
                        <!-- <a href="<?php the_permalink(); ?>">#LeiaMais</a> -->
                    </div>
                    <div class="timeline-Tweet-metadata">
                        <span class="timeline-Tweet-timestamp"><?php echo get_the_date(); ?></span>
                    </div>
                    <ul class="timeline-Tweet-actions">
                        <li class="timeline-Tweet-action">
                            <a class="Icon Icon--heart" href="#">
                                <?php echo get_post_meta( get_the_ID(), 'likes', true ); ?> Curtidas
                            </a>
                        </li>
                        <li class="timeline-Tweet-action">
                            <a class="Icon Icon--share" href="#">Compartilhar</a>
                        </li>
                    </ul>
                </div>
            </div>
